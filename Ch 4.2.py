...
# ============================================================
# Objective:
# Did PBKS bowl significantly fewer dot balls in the middle over
# during matches they lost?
#
# H0:
# There is no difference in middle over dot-ball percentage
...
# ------------------------------------------------------------
# Filter PBKS Bowling - middleover
# ------------------------------------------------------------

middleover = df[
    (df["bowling_team"] == "PBKS") &
    ((df["over_no"] >= 6) & (df["over_no"] < 15))
].copy()
...
middleover["dot_ball"] = (
    (middleover["is_legal_delivery"] == True) &
    (middleover["total_runs"] == 0)
)
...
dot_ball_pct = (
    middleover.groupby(["match_id", "innings_no", "bowling_result"])
      .agg(
...
if p_value < alpha:
    print("Reject H₀.")
    print("PBKS bowled significantly fewer dot balls in middleover during losses.")
else:
    print("Fail to reject H₀.")
    print("No significant difference in middleover dot-ball percentage between wins and losses.")
