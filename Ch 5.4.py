# Death over order wise analysis of bowling pressure index 
"""
Death Over order Bowling Pressure Index (PBKS)
...
# ============================================================
# death over Bowling Pressure Index (PBKS)
# Overs 15-19
# ============================================================
...
# ------------------------------------------------------------
# Filter PBKS Bowling - death Overs (Overs 15-19)
# ------------------------------------------------------------
...
summary = (
    death.groupby(["match_id", "innings_no", "bowling_result"])
      .agg(
...
if len(win) < 2 or len(loss) < 2:
    ...
    print("\n==============================")
    print("Death over Bowling Pressure Index")
    print("==============================")
    ...
    if p_value < alpha:
        print("Reject H₀.")
        print("PBKS had a significantly higher Death Over Bowling Pressure Index in wins.")
    else:
        print("Fail to reject H₀.")
        print("No significant difference in Death Over Bowling Pressure Index between wins and losses.")
